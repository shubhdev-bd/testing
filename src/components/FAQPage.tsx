  ...
  const faqData: FAQItem[] = [
    {
      ...
      answer:
        "To check your NEET UG 2025 result: 1) Visit the official website www.neet.nta.nic.in 2) Click on 'NEET UG Result 2025' link 3) Enter your application number and password 4) Download your scorecard for future reference. Keep multiple copies of your scorecard as it's required for counseling.",
      category: "neet-ug",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      answer:
        "NEET PG is for admission to postgraduate medical courses (MD/MS/Diploma) while NEET UG is for undergraduate courses (MBBS/BDS). NEET PG requires an MBBS degree for eligibility, has different exam pattern, and separate counseling process. The competition is generally higher in NEET PG.",
      category: "neet-pg",
    },
    {
      id: 6,
      ...
      answer:
        "INICET (Institute of National Importance Combined Entrance Test) is for admission to PG medical courses in AIIMS, JIPMER, PGIMER, and NIMHANS. Only MBBS graduates are eligible. It's conducted separately from NEET PG and has its own counseling process.",
      category: "inicet",
    },
    {
      id: 7,
    ...
    },
    {
      ...
      answer:
        "AIIMS admission through INICET: 1) Qualify INICET exam 2) Participate in INICET counseling 3) Choice filling for AIIMS centers 4) Seat allotment based on rank 5) Document verification 6) Fee payment and admission confirmation.",
      category: "inicet",
    },
    {
      id: 18,
    ...
    },
    {
      ...
      answer:
        "State quota counseling process: 1) Check state counseling authority website 2) Register with required documents 3) Pay counseling fee 4) Fill choices of colleges 5) Attend counseling rounds 6) Document verification 7) Seat confirmation and fee payment.",
      category: "counseling",
    },
    {
      id: 20,
    ...
    },
    {
      ...
      answer:
        "NEET UG counseling fees vary: 1) AIQ counseling: ₹1,000 for registration 2) State counseling: ₹500-2,000 depending on state 3) Security deposit: ₹2,00,000 for government colleges 4) Additional fees for choice modification and upgradation.",
      category: "counseling",
    },
    {
      id: 25,
    ...
    },
    {
      ...
      answer:
        "NEET PG result checking: 1) Visit NBE official website 2) Click on NEET PG result link 3) Enter roll number and password 4) Download scorecard 5) Check rank and percentile 6) Save multiple copies for counseling.",
      category: "neet-pg",
    },
    {
      id: 28,
    ...
    },
    {
      ...
      answer:
        "Management quota application: 1) Contact college directly 2) Submit required documents 3) Appear for college interview 4) Pay higher fees as per college norms 5) No counseling required 6) Direct admission based on NEET score and college criteria.",
      category: "counseling",
    },
    {
      id: 30,
      ...
      answer:
        "Key differences: 1) Fee: Government colleges have lower fees 2) Infrastructure: Both can have good facilities 3) Faculty: Government colleges often have experienced faculty 4) Admission: Government through counseling, private through management quota 5) Bond: Government colleges may have service bonds.",
      category: "counseling",
    },
    {
      id: 31,
    ...
    },
    {
      ...
      answer:
        "INICET counseling: 1) Registration on official website 2) Choice filling for institutes 3) Seat allotment based on rank 4) Document verification 5) Fee payment 6) Admission confirmation 7) Multiple rounds conducted.",
      category: "inicet",
    },
    {
      id: 33,
      ...
      answer:
        "Domicile certificate process: 1) Apply to district collector office 2) Submit required documents (birth certificate, school certificates) 3) Pay prescribed fees 4) Verification process 5) Certificate issuance 6) Valid for counseling in respective state.",
      category: "counseling",
    },
    {
      id: 34,
    ...
    },
    {
      ...
      answer:
        "NEET PG counseling timeline: 1) Registration: Usually starts 2-3 weeks after result 2) Choice filling: 3-4 days 3) Seat allotment: Multiple rounds 4) Document verification: 2-3 days per round 5) Classes start: As per academic calendar 6) Check official notifications for exact dates.",
      category: "neet-pg",
    },
    {
      id: 37,
      ...
      answer:
        "Category certificate process: 1) Apply to competent authority (Tehsildar/SDM) 2) Submit required documents 3) Income certificate for EWS 4) Caste certificate for SC/ST/OBC 5) Validity: Usually 1-3 years 6) Required for counseling and admission.",
      category: "counseling",
    },
    {
      id: 38,
    ...
    },
    {
      ...
      answer:
        "Deemed vs Private: 1) Deemed: Government recognition, autonomous status 2) Private: Privately funded, affiliated to state universities 3) Fee structure: Both generally expensive 4) Quality: Varies by institution 5) Recognition: Both recognized for practice 6) Admission: Through NEET counseling or management quota.",
      category: "counseling",
    },
    {
      id: 43,
    ...
    },
    {
      ...
      answer:
        "INICET result process: 1) Results declared on official website 2) Scorecard download available 3) Rank and percentile provided 4) Category-wise results 5) Counseling schedule announced 6) Merit list preparation for counseling.",
      category: "inicet",
    },
    {
      id: 45,
    ...
    },
    {
      ...
      answer:
        "INICET counseling fees: 1) Registration fee varies by institute 2) Security deposit required 3) Counseling participation fee 4) Document verification charges 5) Seat acceptance fee 6) Check individual institute notifications for exact amounts.",
      category: "inicet",
    },
    {
      id: 49,
      ...
      answer:
        "Managing counseling stress: 1) Stay informed about process 2) Prepare documents in advance 3) Have backup options ready 4) Seek family and peer support 5) Practice relaxation techniques 6) Stay positive and focused 7) Consult counselors if needed.",
      category: "counseling",
    },
    {
      id: 50,
        ...
        <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-3xl p-8 text-white mb-8 shadow-xl">
          <div className="text-center">
            ...
            <p className="text-blue-100 text-lg">
              Find answers to common questions about NEET, counseling, and
              medical admissions
            </p>
          </div>
        </div>
