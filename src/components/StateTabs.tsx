...
/**
 * StateTabs Component
 * Displays state-wise counseling tabs with navigation
...
const StateTabs: React.FC<StateTabsProps> = ({ activeTab, onTabChange }) => {
  ...
  const tabs = [
    { id: 'all-india', label: 'All India Counselling - UG Medical', shortLabel: 'All India - UG Medical', icon: '🏥', color: 'from-orange-500 to-red-600' },
    { id: 'andhra', label: 'Andhra Pradesh Management Quota', shortLabel: 'Andhra Pradesh Mgmt', icon: '🏛️', color: 'from-green-500 to-teal-600' },
    { id: 'assam', label: 'Assam - UG Medical', shortLabel: 'Assam - UG Medical', icon: '🏥', color: 'from-blue-500 to-indigo-600' },
    { id: 'maharashtra', label: 'Maharashtra - UG Medical', shortLabel: 'Maharashtra - UG', icon: '🏥', color: 'from-purple-500 to-pink-600' },
    { id: 'karnataka', label: 'Karnataka - Medical Counselling', shortLabel: 'Karnataka Medical', icon: '🏥', color: 'from-indigo-500 to-blue-600' },
  ];
